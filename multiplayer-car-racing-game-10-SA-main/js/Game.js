class Game {
  ...
  start() {
    ...
    var obstacle21Positions = [
      { x: width / 2 - 250, y: height - 800, image: obstacle21Image },
      { x: width / 2 - 180, y: height - 1800, image: obstacle21Image },
      { x: width / 2, y: height - 2800, image: obstacle21Image },
     
      { x: width / 2 + 180, y: height - 3300, image: obstacle21Image },
      { x: width / 2 + 250, y: height - 3800, image: obstacle21Image },
    ];
